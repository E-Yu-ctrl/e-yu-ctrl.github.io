...
const CONFIG = {
  github: {
    username: 'e-yu-ctrl', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['E-Yu-ctrl/biol4810',], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
      ...
      projects: [
        {
          ...
          imageUrl:
            'https://github.com/E-Yu-ctrl/e-yu-ctrl.github.io/raw/main/MicrobioEssay_SS.jpeg',
